...
import com.dylan.pass.repository.notification.NotificationEntity;
import com.dylan.pass.repository.notification.NotificationRepository;
...
public class SendNotificationItemWriter implements ItemWriter<NotificationEntity> {
    ...
    public void write(List<? extends NotificationEntity> notificationEntities) throws Exception {
        ...
        log.info("SendNotificationItemWriter - write: Successful transmission of {}/{} alarms before class", count, notificationEntities.size());
